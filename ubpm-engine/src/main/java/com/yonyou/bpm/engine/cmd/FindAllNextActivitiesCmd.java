...
public class FindAllNextActivitiesCmd implements Command<List<PvmActivity>> {
     ...
     * @param taskId
     */
    public FindAllNextActivitiesCmd(String taskId){
    	this.taskId=taskId;
    }
    /**
     * 获取任务的下一步人工活动(解析条件)
     * @param taskId
     */
    public FindAllNextActivitiesCmd(String taskId,boolean ignoreConditions){
    	this.taskId=taskId;
     ...
     */
    public FindAllNextActivitiesCmd(ActivityExecution activityExecution,Task  task,ProcessDefinitionEntity processDefinitionEntity,String activityId,boolean ignoreConditions){
     ...
     * @param activityId
     */
    public FindAllNextActivitiesCmd(String processDefinitionId, String activityId) {
...
//              	}
//              }
              if (BpmnXMLConstants.ELEMENT_TASK_USER.equals(targetActivity.getProperty("type")) || "approveUserTask".equals(targetActivity.getProperty("type")) || 
            		  BpmnXMLConstants.ELEMENT_TASK_SCRIPT.equals(targetActivity.getProperty("type")) || 
            		  BpmnXMLConstants.ELEMENT_EVENT_END.equals(targetActivity.getProperty("type")) || 
            		  BpmnXMLConstants.ELEMENT_TASK_SERVICE.equals(targetActivity.getProperty("type")) || 
            		  BpmnXMLConstants.ELEMENT_TASK_MAIL.equals(targetActivity.getProperty("type"))) {
